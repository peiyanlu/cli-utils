 ...
 * */
export const gitBranchCurrent = async () => {
 ...
 */
export const gitBranchMove = async (oldName: string, newName: string) => {
 ...
 * @defaults `git branch -M <old-name> <new-name>`
 */
export const gitBranchMoveForce = async (oldName: string, newName: string) => {
  await gitBranch([ '-M', oldName, newName ])
}
 ...
 */
export const gitBranchDelete = async (branch: string) => {
 ...
 * @defaults `git branch -D <branch>`
 */
export const gitBranchDeleteForce = async (branch: string) => {
  await gitBranch([ '-D', branch ])
}
